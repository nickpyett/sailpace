...
export default function CompetitorRow({ competitor, startDateTime, onCompetitorChangeHandler, onCompetitorLapChange, onCompetitorLapSet, onRemoveCompetitorClickHandler }) {
    function handleCompetitorChangeHandler(e) {
        onCompetitorChangeHandler(competitor, e.target.name, e.target.value);
    }

    function handleRemoveCompetitorClickHandler() {
    ...
    return (
        <tr className="border-b border-gray-300">
            <td className="p-2 w-16 text-center">{competitor.ordinal} <button type="button" onClick={handleRemoveCompetitorClickHandler} className="cta-small ml-2">x</button></td>
            <td className="p-2 w-36"><input type="text" name="name" value={competitor.name} onChange={handleCompetitorChangeHandler} className="w-32" /></td>
            <td className="p-2 w-36"><input type="text" name="number" value={competitor.number} onChange={handleCompetitorChangeHandler} className="w-32" /></td>
            <td className="p-2 w-36"><input type="text" name="class" value={competitor.class} onChange={handleCompetitorChangeHandler} className="w-32" /></td>
            {competitorLaps}
